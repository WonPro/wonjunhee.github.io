$(document).ready(function(){
    ...
    <div class="darkBg">
        <div class="contBox">
            ...
            <div class="info">
                ...
                <p class="like">Like&nbsp;<span>331</span></p>
            </div>
        </div>
    </div>
    `;
    ...
    $(".grid-item").each(function(index){
        $(this).css("background-image", "url(img/interior/interior"+(index+1)+".jpg)")
    });
    ...
    $(".grid-item, .grid .darkBg").click(function(){
        ...
        $(".imgPopup .popupImg").css("background-image", "url(img/interior/interior"+($index+1)+".jpg)");
    });
